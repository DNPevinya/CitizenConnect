...
const seedComplaints = async () => {
    ...
    // Format: [user_id, category, title, description, location_text, status, created_at, authority_id]
    const fakeComplaints = [
        // JANUARY - Resolved (Testing Infrastructure & Health)
        ...
        // FEBRUARY - Resolved & In Progress (Safety & Water)
        ...
        // MARCH - Mixed (Urban Planning & Electricity)
        ...
        // APRIL - Current Month (Transport & Admin)
