              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-[#E2E8F0] bg-[#F8FAFC]">
                    <th className="px-6 py-4 text-[10px] font-bold text-[#64748B] uppercase">Complaint ID</th>
                    <th className="px-6 py-4 text-[10px] font-bold text-[#64748B] uppercase">Citizen Info</th>
                    <th className="px-6 py-4 text-[10px] font-bold text-[#64748B] uppercase">Type / Issue</th>
                    <th className="px-6 py-4 text-[10px] font-bold text-[#64748B] uppercase">Status</th>
                    <th className="px-6 py-4 text-[10px] font-bold text-[#64748B] uppercase text-center">Action</th>
                  </tr>
                </thead>
                  ...
                  {loading ? (
                    ...
                    <tr key={c.complaint_id} className="hover:bg-[#F8FAFC] transition-colors">
                      ...
                      <td className="px-6 py-4">
                        {/* SHOW REAL NAME AND PHONE NUMBER */}
                      ...
                      <td className="px-6 py-4 text-center">
                        <button onClick={() => navigate(`/officer/complaint-details?id=${c.complaint_id}`)} className="p-1.5 text-[#0041C7] bg-[#F0F5FF] rounded hover:bg-[#DCE7F9]">
